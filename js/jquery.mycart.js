  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<button type="button" class="close text-danger fs-5" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>' +
        ...
        '<button type="button" class="btn btn-success ' + classCheckoutCart + '">Checkout</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
